...
# Global variables
mix = "Tetradecane005" # number of the mixture - e.g Pentane09
workPath = "/home/Fulano/Tetradecane/" + mix + "/"
...
mid_type    = 'C15'        # atom that connects pABA and Cellulose
...
for frame in dcd[0]: # iterate through dcd file
...
for h in range(len(heights)):
    print heights[h] - baseTypeList[h]
