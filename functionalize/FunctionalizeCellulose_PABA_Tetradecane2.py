...
for i in range(len(densities)):
	...
	for i in ohPlaces:
	  ...
	  if coords[2] > (VERTICAL_N-1) * dz:  # get only the top O's
        ...
        oh[0].getForceField().setBond(('C150', 'O600'), 1.42, 1)
        oh[0].getForceField().setBond(('C150', 'O600'), 428, 0)
        oh[0].getForceField().setBond(('C150', 'O200'), 1.42, 1)
        oh[0].getForceField().setBond(('C150', 'O200'), 428, 0)

        oh[0].getForceField().setAngle(('C150', 'O200', 'C200'), 131.929, 0)
        oh[0].getForceField().setAngle(('C150', 'O200', 'C200'), 78., 1)
        oh[0].getForceField().setAngle(('C150', 'O600', 'C600'), 131.929, 0)
        oh[0].getForceField().setAngle(('C150', 'O600', 'C600'), 104., 1)

        oh[0].getForceField().setAngle(('C140', 'C150', 'O600'), 113.391, 0)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O600'), 40., 1)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O200'), 113.391, 0)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O200'), 40., 1)

        oh[0].getForceField().setBond(('C150', 'O6001'), 1.42, 1)
        oh[0].getForceField().setBond(('C150', 'O6001'), 428, 0)
        oh[0].getForceField().setBond(('C150', 'O2001'), 1.42, 1)
        oh[0].getForceField().setBond(('C150', 'O2001'), 428, 0)

        oh[0].getForceField().setAngle(('C150', 'O2001', 'C2001'), 131.929, 0)
        oh[0].getForceField().setAngle(('C150', 'O2001', 'C2001'), 78., 1)
        oh[0].getForceField().setAngle(('C150', 'O6001', 'C6001'), 131.929, 0)
        oh[0].getForceField().setAngle(('C150', 'O6001', 'C6001'), 104., 1)

        oh[0].getForceField().setAngle(('C140', 'C150', 'O6001'), 113.391, 0)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O6001'), 40., 1)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O2001'), 113.391, 0)
        oh[0].getForceField().setAngle(('C140', 'C150', 'O2001'), 40., 1)
