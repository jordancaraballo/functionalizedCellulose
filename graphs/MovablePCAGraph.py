...
data005 = np.loadtxt('../data/Tetradecane005MultDCDR100.txt',delimiter=',')
data01  = np.loadtxt('../data/Tetradecane01MultDCDR100.txt',delimiter=',')
data02  = np.loadtxt('../data/Tetradecane02MultDCDR100.txt',delimiter=',')
...
# First Simulation
ax.plot(simMols[0::3, 0], simMols[0::3, 1], simMols[0::3, 2], c='b')
